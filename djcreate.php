...
<center><div class="col-md-8">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">AutoDJ | Instanz erstellen</h5>
              </div>
              <div class="card-body">
                <form action="djcreate.php">
                  <div class="row">
                    <div class="col-md-8 px-1">
                      <div class="form-group">
                        <label>SHOUTcast | Streamserver Port:</label>
                        <input type="text" required="required" class="form-control" name="sport" placeholder="Enter your Streamserver port">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                    <div class="form-group">
                        <label>Streamserver Passwort:</label>
                        <input type="text"  required="required" class="form-control" name="spassword" placeholder="Enter your Streamserver password">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required="required" class="form-control" name="stitle" placeholder="Enter your Stream Title">
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required="required" class="form-control" name="surl" placeholder="Enter your Stream URL">
                      </div>
                    </div>
                    <div class="col-md-12 pl-1">
                    <div class="form-group">
                        <label>Musikrichtung:</label>
                        <input type="text" required="required" class="form-control" name="sgenre" placeholder="Enter your Genre">
                      </div>
                    </div>
                  </div>
  
                  <div class="form-group">
                        <input type="hidden" class="form-control" name="method" value="djcreate">
                      </div>
                    </div>
...
$sport = escapeshellcmd($_GET['sport']);
$spassword = escapeshellcmd($_GET['spassword']);
$stitle = escapeshellcmd($_GET['stitle']);
$surl = escapeshellcmd($_GET['surl']);
$sgenre = escapeshellcmd($_GET['sgenre']);
...
else
{
    ...
    {
    	if($method == "djcreate" || $method == "djcreate")
    	{

			$gen3 = rand(1,5000);
			include 'inc/sql.php';
	        if(!($stream = ssh2_exec($con, "screen -AmdS LB-Streaming-API /root/lb-streaming/autodj_instance ".$sport." ".$spassword."  ".$stitle." ".$surl." ".$sgenre))) die("Command couldn't be executed, something went wrong...\n");
	        else
	        {
      ...
      $playlist = "/home/RawAutoDJ/AutoDJ-StreamPort-$sport/PLAYLIST";

				mysqli_query($conn, "INSERT INTO autodj_instances (`id`, `Stream_Port`, `Stream_Passwort`, `Stream_Titel`, `Stream_URL`, `Musikrichtung`, `playlist`) VALUES ('" . $gen3 . "', '" . $sport . "', '" . $spassword . "', '" . $stitle . "', '" . $surl . "', '" . $sgenre . "', '" . $playlist . "')");
        ssh2_disconnect($con);
          ...
          <div class="row">
            ...
            <div class="credits ml-auto">
              <span class="copyright">
                ...
                </script>, Coded by <i class="fa fa-heart heart"></i> RAW Networks & NetworkSystems
              </span>
            </div>
          </div>
        </div>
